...
const leaders = [
  ...
  },
  {
    ...
    linkedin: "https://www.linkedin.com/in/chris-robinson-979940b/" as string | undefined,
  },
  {
...
const LeaderCard = ({ leader }: { leader: typeof leaders[0] }) => (
  <div className="border border-border bg-card p-8">
    <div className="flex items-center gap-3 mb-1">
      <h3 className="font-display font-bold text-lg tracking-tight">{leader.name}</h3>
      {leader.linkedin && (
        <a
