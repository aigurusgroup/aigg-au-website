      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-2xl">
            ...
            <h2 className="text-3xl lg:text-4xl font-display font-bold tracking-tight text-foreground mb-6">The Opportunity</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              Across Australia, thousands of established service businesses operate in highly fragmented markets with limited operational infrastructure. Many are founder-led, under-systemised, and approaching a natural point of transition.
            </p>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="mb-16 max-w-2xl">
            ...
            <h2 className="text-3xl lg:text-4xl font-display font-bold tracking-tight text-foreground">How Value Is Created</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-border">
            {valueDrivers.map((driver) => (
              <div key={driver.num} className="bg-card p-8">
                ...
                <h3 className="font-display font-bold text-lg mb-3 tracking-tight text-foreground">{driver.title}</h3>
      ...
      <section className="py-24 bg-card">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-2xl">
            ...
            <h2 className="text-3xl lg:text-4xl font-display font-bold tracking-tight text-foreground mb-6">Investment Approach</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              ...
              <h2 className="text-3xl lg:text-4xl font-display font-bold tracking-tight text-foreground mb-6">Multi-Market Platform</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <div>
              ...
              <h2 className="text-3xl lg:text-4xl font-display font-bold tracking-tight text-foreground mb-6">Who We Work With</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
      ...
      <section id="investor-form" className="py-24 bg-card">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-3xl lg:text-4xl font-display font-bold tracking-tight text-foreground mb-3">
