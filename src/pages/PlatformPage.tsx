      ...
      <section className="pt-28 pb-20 bg-card">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl lg:text-5xl font-display font-bold tracking-tight text-foreground mb-6">The AIGG Platform</h1>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-2xl">
            ...
            <h2 className="text-3xl lg:text-4xl font-display font-bold tracking-tight text-foreground mb-6">A System, Not a Series of Deals</h2>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="mb-16 max-w-2xl">
            ...
            <h2 className="text-3xl lg:text-4xl font-display font-bold tracking-tight text-foreground">How the Platform Works</h2>
          </div>
      ...
      <section className="py-24 bg-card">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="mb-16 max-w-2xl">
            ...
            <h2 className="text-3xl lg:text-4xl font-display font-bold tracking-tight text-foreground">Operating Model</h2>
          </div>
          <div className="grid lg:grid-cols-3 gap-px bg-border">
            {operatingModel.map((item, i) => (
              <div key={i} className="bg-background p-10">
                <h3 className="font-display font-bold text-lg mb-3 tracking-tight text-foreground">{item.title}</h3>
