...
const whyPillars = [
  {
    ...
    description: "We acquire to build — not to flip. Our model is centred on sustainable growth and long-term value creation.",
  },
  {
    icon: Layers,
    title: "Structured Approach",
    description: "Every acquisition follows a disciplined process — from initial discussion through to integration and growth.",
  },
  {
    icon: Cpu,
    title: "Operational Expertise",
    description: "Our platform provides centralised operations, AI-enabled systems, and hands-on support from experienced operators.",
  },
  {
    icon: Settings,
    title: "Flexible Structures",
    description: "Full exit, partial exit, or earnout — we tailor deal structures to meet the needs and goals of every owner.",
  },
];
      ...
      <section className="pt-28 pb-20 bg-card">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl lg:text-5xl font-display font-bold tracking-tight text-foreground mb-6">
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-2xl">
            ...
            <h2 className="text-3xl lg:text-4xl font-display font-bold tracking-tight text-foreground mb-6">
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="mb-16 max-w-2xl">
            ...
            <h2 className="text-3xl lg:text-4xl font-display font-bold tracking-tight text-foreground">Our Process</h2>
          </div>
          ...
          <div className="hidden lg:flex items-center justify-center gap-4 mb-12">
            {processSteps.map((step, i) => (
              <div key={i} className="flex items-center gap-4">
                <span className="font-display font-bold text-sm tracking-tight text-foreground">{step.title}</span>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-border">
            {processSteps.map((step) => (
              <div key={step.num} className="bg-card p-8">
                ...
                <h3 className="font-display font-bold text-lg mb-3 tracking-tight text-foreground">{step.title}</h3>
      ...
      <section className="py-24 bg-card">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-2xl">
            ...
            <h2 className="text-3xl lg:text-4xl font-display font-bold tracking-tight text-foreground mb-6">What We Look For</h2>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-2xl">
            ...
            <h2 className="text-3xl lg:text-4xl font-display font-bold tracking-tight text-foreground mb-6">What Matters to Us</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
