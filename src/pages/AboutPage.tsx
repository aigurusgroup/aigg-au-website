    ...
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
                <p>
                  Lee Robinson founded AIGG with a clear thesis: Australia's service economy is filled with exceptional
                  businesses run by founders approaching transition — and these businesses deserve better options than
                  being absorbed by generic roll-ups or left to decline.
                </p>
                <p>
                  With 20+ years across finance, operations, and acquisitions in both the UK and Australia, Lee has
                  seen first-hand how AI and operational discipline can transform good businesses into great ones.
                </p>
              </div>
            </div>
            <div>
              ...
              <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
                <p>
                  To acquire promising service businesses and strengthen them through intelligent automation,
                  modern systems, and customer-focused innovation — driving sustainable growth for founders,
                  teams, and investors.
                </p>
                <p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 lg:px-8 max-w-3xl">
          ...
          <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
            <p>
              Most service businesses operate on systems built 10–15 years ago. Their processes work, but they're
              manual, slow, and expensive. AI isn't about replacing people — it's about removing friction, automating
              the mundane, and letting skilled professionals focus on what matters.
            </p>
            <p>
              When you combine this operational capability with disciplined acquisition, you create something
              powerful: a platform that gets better with every business it adds.
            </p>
          </div>
        </div>
      </section>
