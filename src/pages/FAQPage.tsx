...
const popularQuestions: FAQItem[] = [
  {
    q: "How does AIGG differ from a traditional private equity buyer?",
    a: "We are operator-led, not financially engineered. Our team has direct experience running and scaling service businesses. We acquire, integrate, and operate - we don't strip assets or flip for short-term returns.",
    related: { label: "Our Platform", href: "/platform" },
  },
  {
    q: "What happens to my team after an acquisition?",
    a: "Your team stays. We retain management, preserve culture, and provide additional resources - from centralised back-office support to AI-enabled tools - so your people can focus on what they do best.",
    related: { label: "Our Approach", href: "/sell" },
  },
  {
    q: "What types of businesses does AIGG acquire?",
    a: "We target profitable, well-run service businesses generating $2M-$20M in revenue. We focus on sectors where operational improvement and platform integration create significant long-term value.",
    related: { label: "Acquisition Criteria", href: "/sell" },
  },
  {
    q: "How are investors' returns structured?",
    a: "Returns are generated through a combination of operational improvement, bolt-on acquisitions, and long-term platform value creation. We provide transparent reporting with quarterly updates on portfolio performance.",
    related: { label: "For Investors", href: "/investors" },
  },
  {
    q: "Is the initial conversation confidential?",
    a: "Absolutely. Every conversation begins under a strict confidentiality framework. We never disclose your identity, financials, or intent to sell without your explicit written consent.",
    related: { label: "Start a Conversation", href: "/sell" },
  },
  {
    q: "What is the typical acquisition timeline?",
    a: "From initial conversation to completion, most transactions take 8-16 weeks. We move efficiently because our team handles diligence, legal, and integration in-house.",
    related: { label: "Our Process", href: "/sell" },
  },
];
...
const categories: FAQCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Where does AIGG operate?", a: "We currently operate across Australia and the United Kingdom, with a structured expansion plan into additional geographies. Each market follows the same disciplined acquisition and integration playbook." },
    ],
  },
  {
    title: "How It Works",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-navy pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h1
            className="text-4xl md:text-5xl lg:text-6xl font-bold text-card mb-6"
          ...
          <div className="flex justify-center gap-3 mb-8">
            <button
              ...
              className={`px-6 py-2.5 rounded-full text-sm font-medium transition-all ${
                audience === "owners"
                  ? "bg-card text-navy"
                  : "border border-card/30 text-card/70 hover:border-card/60 hover:text-card"
              }`}
            >
              Business Owner
            </button>
          ...
          <div className="relative max-w-xl mx-auto">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 rounded-xl bg-card text-foreground text-base placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-accent-blue shadow-lg"
            />
          </div>
        </div>
      </section>
      ...
      <div className="sticky top-0 z-30 bg-card/95 backdrop-blur border-b border-border py-3 px-6 md:hidden">
        <div className="relative max-w-xl mx-auto">
          ...
          <input
            ...
            value={search}
            onChange={(e) => setSearch(e.target.value)}
            className="w-full pl-10 pr-4 py-2.5 rounded-lg bg-background text-sm border border-border focus:outline-none focus:ring-2 focus:ring-accent-blue"
          />
        </div>
      </div>
        ...
        <section className="py-20 bg-card">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <p className="text-muted-foreground mb-10">
              The questions we hear most from business owners and investors.
            </p>
            <Accordion
              type="multiple"
              defaultValue={popularQuestions.map((_, i) => `pop-${i}`)}
            >
                  ...
                  <AccordionContent className="text-muted-foreground leading-relaxed pb-5">
                    ...
                    {item.related && (
                      <Link
                        ...
                        className="flex items-center gap-1 mt-3 text-sm font-medium text-accent-blue hover:underline"
                      >
                        {item.related.label}{" "}
              ...
              <div key={cat.title}>
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-lg bg-accent-blue/10 flex items-center justify-center">
                    <cat.icon className="h-5 w-5 text-accent-blue" />
                  </div>
                  <h3
                    ...
                    >
                      ...
                      <AccordionContent className="text-muted-foreground text-sm leading-relaxed px-6 pb-4">
                        ...
                        {item.related && (
                          <Link
                            to={item.related.href}
                            className="inline-flex items-center gap-1 mt-2 text-xs font-medium text-accent-blue hover:underline"
                          >
                            {item.related.label}{" "}
      ...
      <section className="py-20 bg-card">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <Accordion
            type="multiple"
            defaultValue={conversionFAQs.map((_, i) => `conv-${i}`)}
            className="bg-slate-section rounded-xl border border-border overflow-hidden mb-12"
          >
          ...
          <div className="text-center bg-navy rounded-2xl p-10 md:p-14">
            <h3
              className="text-2xl md:text-3xl font-bold text-card mb-4"
              style={{ fontFamily: "var(--font-display)" }}
            >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                asChild
                className="bg-accent-blue hover:bg-accent-blue/90 text-card px-8 py-3 rounded-lg"
              >
              ...
              <Button
                asChild
                variant="outline"
                className="border-card/30 text-foreground bg-card hover:bg-card/10 hover:text-card px-8 py-3 rounded-lg"
              >
